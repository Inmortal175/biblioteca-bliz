...
import {CreateLibroModel,FormLibroModel,LibroModelListResult,} from 'src/app/Models/Libro/LibroCreateModel';
import { LibroModelList } from 'src/app/Models/Libro/LibroCreateModel';
import {EditorialModel,EditorialModelResult,} from 'src/app/Models/Editorial/EditorialModel';
...
export class LibrosPageComponent implements OnInit {
    ...
    llenarLibro() {
        this.LibroService.getLibro(this.inputLibros, this.LibroParam.page, this.LibroParam.pageSize).subscribe((data: LibroModelList) => {
    ...
    llenarProveedor() {
        this.LibroService.getProveedores().subscribe(   
            data => {
    ...
    changePageSizeLibro() {
        ...
        this.LibroPageSize = parseInt(
            this.LibroPageSizeForm.value.pageSize
        );
